...
@NgModule({
  ...
  imports: [
    ...
    // StoreModule.forFeature('assignQuiz', assignQuizReducer),
    // EffectsModule.forFeature([AssignQuizEffects]),
    StoreModule.forRoot({
      assignQuiz: assignQuizReducer,
      chat: chatReducer,
    }),
    EffectsModule.forRoot([AssignQuizEffects, ChatEffects]),
  ],
  providers: [DatePipe],
